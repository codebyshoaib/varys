...
description: |
  ...
  "remind me about X", "what's Mahnoor working on". Reads varys_people + vault/memory.
tools:
  - Read
  - Bash
  - Glob
...
## How You Work
1. Read `.claude/skills/varys/helping-team.md` for per-person preferences.
2. Check `vault/memory/` for relevant memory files.
3. Check `.claude/hooks/varys_people.py` for people DB patterns.
...
- Update `.claude/skills/varys/helping-team.md` if you learn a new preference.
