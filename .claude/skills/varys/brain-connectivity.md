# Brain Connectivity — How Varys Wires Knowledge

> The rules for connecting new information across Varys's brain.
> Read this before any task that adds new knowledge to the system.
> Brain DB: ~/.varys-harness/brain.db
...
| skill | Any skill file in .claude/skills/varys/ | skill-avatar |
...
```
skill-X → is_part_of → varys_harness
...
from varys_brain import get_brain_db, find_entity, query_facts
db = get_brain_db()
