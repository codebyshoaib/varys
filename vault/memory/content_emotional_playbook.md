...
# The Emotional Content Playbook
> READ THIS BEFORE CREATING ANY CONTENT — scripts, captions, topic picks, hooks, NLM prompts, slide decks, infographics. Every piece of content must pass these filters.

---

## The One Idea Everything Rests On

**The consumer is a human, not an algorithm.** Optimize for a feeling inside one person — the reach follows.

A person opens Instagram tired, restless, bored, or avoiding something. They want to *feel their way out* for 30 seconds. Your video's job is to be those 30 seconds — clean, beautiful, emotionally complete.
...
## The Most Important Mechanic: Arousal Beats Valence

Sharing is an action — it needs an energized body. High-arousal emotions drive sharing regardless of whether they're positive or negative.

| Emotion | Feels | Energy | Gets shared? |
|---|---|---|---|
| **Awe** | positive | HIGH | ✅ Strongly |
| **Amusement** | positive | HIGH | ✅ Yes |
| Anger | negative | HIGH | Yes — NOT our lane |
| Anxiety | negative | HIGH | Yes — NOT our lane |
...
### Topic Filters — kill an idea if it fails these:
- **Send Test:** Would a real person send this to a friend? ("we have to go here" / "this is so us")
- **Identity Test:** Does sharing this say something flattering about the viewer? ("I have taste," "I love my country")
- **Relatability Test:** Can the viewer see themselves in it?
- **One-Feeling Test:** Can you name the single emotion? One video = one feeling.

---

## The 4-Beat Script Structure

```
TOPIC:
ANGLE:
THE ONE EMOTION (one word):

[0–3s] HOOK — win this or nothing else matters
  First frame (visual): ______
  Text overlay (4–7 words, high contrast, away from edges): ______
  Sound: ______

[3–6s] BUILD — hold the tension, keep the loop open
  Setup line / visual: ______
  Open loop still open? Y/N

[6s+] PAYOFF — deliver the feeling you promised
  The reveal / the point: ______

[last 2–5s] ENDING
  ☐ Loop back to first frame (for ambient/awe content), OR
  ☐ Emotional button line: ______
  Soft CTA (save / comment / follow): ______
```

### Hook Rules:
- No logo. No "hey guys." No slow intro. Most striking thing first.
- First frame stops the scroll on its own.
- Works with sound OFF — text overlay 4–7 words.
...
- Mood first, genre second — decide the feeling, then find a track.
- Match: strings/piano = awe/longing. Warm acoustic = nostalgia/belonging. Upbeat = joy/motion.
- Cut to the beat. Sync cuts to music — quick cuts on snappy beats, slow dissolves on smooth tracks.
- **Use silence at the climax** — dropping music at the payoff (summit reveal, first bite) creates a held breath. When sound returns it hits twice as hard.
- Capture and keep ambient sound: streams, wind, rain, oil hitting pan, splash. These bypass the thinking brain and make viewers feel *there*.
- For ambient/loop videos: pick the track first, cut visuals to it.

---

## Episodic Content (how to build people who wait for you)
...
Steps:
1. Define the arc (clear beginning and end)
2. Plan cadence (consistency trains audience and algorithm)
3. Build anticipation (end each part with hook: "Part 2 tomorrow")
4. Invite participation (polls, questions)
5. Measure & adapt (which episode holds best?)

---

## Voice Rules for Writing

- Write the way you talk. Read every script out loud. If you wouldn't say it to a friend over chai, cut it.
- Short sentences. One idea per line.
- Specifics beat generalities. Not "the food was amazing" — "the naan was so hot it burned my fingers and I didn't care."
- Use 'you' and 'I'. "I" builds parasocial bond. "You" pulls the viewer into the moment.
- **Earn the emotion, don't announce it.** Don't say "this is so emotional." Show the thing that makes them feel it.

---

## Warnings — Protect the Long Game
...
> **Pick a single feeling. Promise it in the first 3 seconds. Deliver it honestly by the end. Be unmistakably yourself every time.**
